...
CONFIG_FILES="C:\WorkingFolders\FWD\NewWorldDB\flyway.toml,C:\WorkingFolders\FWD\NewWorldDB\flyway.user.toml"
...
# generic deployment
read -p "Press Enter to run migrate command..."
...
read -p "Press Enter to run snapshot command..."
...
read -p "Press Enter to run undo command..."
...
# cherryPick forward
read -p "Press Enter to run cherry-pick migrate command..."
...
# drift and code analysis report with snapshots
    ...
    read -p "Press Enter to run drift check command..."
